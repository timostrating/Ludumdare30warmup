...
public class RagePixelSpriteEditor : Editor
{
    ...
    public enum BrushType { Brush1 = 0, Brush3, Brush5 };
            ...
            switch (brushType)
            {
                ...
                case (BrushType.Brush3):
                    if (_brush33 == null)
                    {
                        Color[] brush;
                        brush = new Color[3 * 3];
                        brush[0] = new Color(1f, 1f, 1f, 0f); brush[1] = new Color(1f, 1f, 1f, 1f); brush[2] = new Color(1f, 1f, 1f, 0f);
                        brush[3] = new Color(1f, 1f, 1f, 1f); brush[4] = new Color(1f, 1f, 1f, 1f); brush[5] = new Color(1f, 1f, 1f, 1f);
                        brush[6] = new Color(1f, 1f, 1f, 0f); brush[7] = new Color(1f, 1f, 1f, 1f); brush[8] = new Color(1f, 1f, 1f, 0f);
                ...
                case (BrushType.Brush5):
                    if (_brush55 == null)
                    {
                        Color[] brush;
                        brush = new Color[5 * 5];
                        brush[0] = new Color(1f, 1f, 1f, 0f); brush[1] = new Color(1f, 1f, 1f, 1f); brush[2] = new Color(1f, 1f, 1f, 1f); brush[3] = new Color(1f, 1f, 1f, 1f); brush[4] = new Color(1f, 1f, 1f, 0f);
                        brush[5] = new Color(1f, 1f, 1f, 1f); brush[6] = new Color(1f, 1f, 1f, 1f); brush[7] = new Color(1f, 1f, 1f, 1f); brush[8] = new Color(1f, 1f, 1f, 1f); brush[9] = new Color(1f, 1f, 1f, 1f);
                        brush[10] = new Color(1f, 1f, 1f, 1f); brush[11] = new Color(1f, 1f, 1f, 1f); brush[12] = new Color(1f, 1f, 1f, 1f); brush[13] = new Color(1f, 1f, 1f, 1f); brush[14] = new Color(1f, 1f, 1f, 1f);
                        brush[15] = new Color(1f, 1f, 1f, 1f); brush[16] = new Color(1f, 1f, 1f, 1f); brush[17] = new Color(1f, 1f, 1f, 1f); brush[18] = new Color(1f, 1f, 1f, 1f); brush[19] = new Color(1f, 1f, 1f, 1f);
                        brush[20] = new Color(1f, 1f, 1f, 0f); brush[21] = new Color(1f, 1f, 1f, 1f); brush[22] = new Color(1f, 1f, 1f, 1f); brush[23] = new Color(1f, 1f, 1f, 1f); brush[24] = new Color(1f, 1f, 1f, 0f);
